...
ActiveRecord::Schema.define(version: 2019_07_20_084614) do
  ...
  create_table "readings", force: :cascade do |t|
    ...
    t.index ["thermostat_id", "tracking_number"], name: "index_readings_on_thermostat_id_and_tracking_number"
    t.index ["thermostat_id"], name: "index_readings_on_thermostat_id"
    t.index ["tracking_number"], name: "index_readings_on_tracking_number", unique: true
  end
